    ...
    return (
        <>
            ...
            <div className="flex justify-center space-x-2">
                <div className="hover:bg-mono-200 hover:cursor-pointer rounded p-1" onClick={(e) => {handleStart(e)}}>
                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-6 h-6">
                        <path strokeLinecap="round" strokeLinejoin="round" d="M5.25 5.653c0-.856.917-1.398 1.667-.986l11.54 6.348a1.125 1.125 0 010 1.971l-11.54 6.347a1.125 1.125 0 01-1.667-.985V5.653z" />
                    </svg>
                </div>
                <div className="hover:bg-mono-200 hover:cursor-pointer rounded p-1" onClick={() => {
                  const t = new Date();
                ...
                <div className="hover:bg-mono-200 hover:cursor-pointer rounded p-1" onClick={(e) => {setExpiryTimeStamp()}}>
                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-6 h-6">
...
export const Timer = ({index, handleCloseTimer}) => {
    ...
    return (
        <div className="h-full w-full rounded opacity-90 bg-white shadow-inset p-2">
            <div className="absolute right-2">
                <Tooltip tooltip={"Close Timer"} position={"-translate-x-20 translate-y-8"}>
                    <div className='p-1 hover:bg-mono-300 rounded hover:cursor-pointer text-black' onClick={(e) => {handleCloseTimer(index)}}>
            ...
            <div className="flex items-center justify-center h-full w-full text-center text-black">
